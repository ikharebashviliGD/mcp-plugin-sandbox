---
inclusion: manual
description: "List iOS simulators on the machine via XcodeBuildMCP. Use when the user asks which simulators are running, booted, available, or active."
---

# List iOS Simulators

When the user asks about iOS simulators on the machine (running / booted / available / active), follow this guidance exactly.
