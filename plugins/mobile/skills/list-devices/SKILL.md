---
name: list-devices
description: List physical iOS devices connected to the machine. Use whenever the user asks about connected iPhones, iPads, physical devices, real devices, hardware devices, or asks for an inventory of plugged-in iOS hardware.
---

# List Connected iOS Devices

When the user asks about physical iOS devices on the machine (connected / plugged-in / real devices / hardware), follow this skill exactly.
...
- Do not confuse this with the `list-simulators` skill — that one is for virtual simulators, this one is for physical hardware.
