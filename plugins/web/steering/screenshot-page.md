---
inclusion: manual
description: "Take a visual screenshot of the open browser page via Playwright MCP. Use when the user asks for a screenshot, picture, image, or visual capture of a web page."
---

# Take a Page Screenshot

When the user asks for a visual screenshot of a web page, follow this guidance exactly.
...
- Do not confuse this with `page-snapshot` — that captures the accessibility tree (text); this one captures the rendered visual (image).
